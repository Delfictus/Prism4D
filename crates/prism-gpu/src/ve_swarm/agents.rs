...
impl SwarmAgents {
    ...
    pub fn new(ctx: Arc<CudaContext>, ptx_path: &str, config: SwarmConfig) -> Result<Self> {
        ...
        let fn_init = module.load_function("ve_swarm_init_agents")?;
        let fn_predict = module.load_function("ve_swarm_agent_predict")?;
        let fn_consensus = module.load_function("ve_swarm_consensus")?;
        let fn_update = module.load_function("ve_swarm_update_stats")?;
        let fn_evolve = module.load_function("ve_swarm_evolve")?;
        let fn_importance = module.load_function("ve_swarm_feature_importance")?;
